...
use BuddyBoss\PlatformPro\Vendor\GuzzleHttp\Promise\FulfilledPromise;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \BuddyBoss\PlatformPro\Vendor\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \BuddyBoss\PlatformPro\Vendor\GuzzleHttp\Psr7\Utils::streamFor($sink);
