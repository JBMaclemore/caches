...
<div id="wp-ulike-logs-app" data-table-name="ulike" class="wrap wp-ulike-container wp-ulike-stats-panel">
	<div class="wp-ulike-row">
		<div class="col-12">
			<h2 class="wp-ulike-page-title"><?php esc_html_e( 'Posts Vote Logs', WP_ULIKE_PRO_DOMAIN ); ?></h2>
		</div>
	</div>
	<div class="wp-ulike-row">
		<div class="col-12">
			...
			:columns='<?php echo json_encode( wp_ulike_pro_get_admin_logs_columns('post') ); ?>'
			:rows="rows"
			:pagination-options="{
				enabled: true,
				mode: 'records',
