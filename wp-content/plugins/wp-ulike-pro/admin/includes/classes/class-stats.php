...
if ( ! class_exists( 'WP_Ulike_Pro_Stats' ) ) {
	...
	class WP_Ulike_Pro_Stats extends wp_ulike_widget{
		 ...
		 * @return			Array
		 */
		public function get_data( $date_range = array(), $selected_status = array(), $dataset = '', $filter = '' ){
			$output = array();
			...
			if ( strpos( $dataset, 'dataset_' ) !== false ) {
				...
				return $this->get_dataset( $table, $has_daterange );
		 ...
		 * @return void
		 */
		public function get_dataset( $table, $has_daterange ){
			$output  = array();
