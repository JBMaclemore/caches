...
class WP_Ulike_Pro_Options_Panel {
    ...
    public function post_type_options( $options ){
        $options[] = array(
            ...
            'desc'    => esc_html__('By activating this option, the counter data is stored simultaneously in the standard meta table and you can use it to create custom queries.', WP_ULIKE_PRO_DOMAIN) . '<br>' . 'Meta Keys: <code>like_amount</code>, <code>dislike_amount</code>',
    ...
    public function content_options_section( $options ){
        ...
        $options = $this->array_insert_after( $options, 'login_template', array(
            'modal_template' => array(
                ...
                'type'       => 'wp_editor',
                'height'     => '100px',
                'default'    => '[wp_ulike_pro_login_form redirect_to="current_page"]',
  ...
  <span class="ulp-flex-col-md-10 ulp-flex-col-xs-11 ulp-user-info">
    ...
    public function translations_section( $options ){
        ...
        $options[] = array(
            'id'      => 'email_confirmation_notice',
            'type'    => 'text',
            'default' => esc_html__( 'Check your email for the confirmation link.', WP_ULIKE_PRO_DOMAIN ),
        ...
        $options[] = array(
            ...
            'type'    => 'text',
            'default' => esc_html__( 'Check your email for the confirmation link.', WP_ULIKE_PRO_DOMAIN ),
            'title'   => esc_html__( 'Check your email for the confirmation link.', WP_ULIKE_PRO_DOMAIN )
        );
    ...
    public function forms_section( $options ){
        ...
        return array(
            ...
            array(
                ...
                'quicktags'     => true,
                'sanitize'      => false,
                'default'       => __( 'Logged in as {display_name}. (<a href="{profile_url}">Profile</a>) (<a href="{logout_url}">Logout</a>)',WP_ULIKE_PRO_DOMAIN),
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc'       => esc_html__('Please enter your desired action name in this field so that the share buttons are automatically displayed there.', WP_ULIKE_PRO_DOMAIN),
