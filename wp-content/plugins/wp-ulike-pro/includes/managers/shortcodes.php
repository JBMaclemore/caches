...
function  wp_ulike_pro_profile_shortcode( $atts ){
    ...
    if( wp_ulike_is_true( $args['force_current_user'] ) ){
...
function  wp_ulike_pro_reset_password_form_shortcode( $atts ){
    ...
    $args = shortcode_atts( array(
        ...
        "mail_message"   => WP_Ulike_Pro_Options::getFormLabel( 'rp', 'mail_message', esc_html__( 'Check your email for the confirmation link.', WP_ULIKE_PRO_DOMAIN ) ),
        ...
        "invalidkey"     => WP_Ulike_Pro_Options::getFormLabel( 'rp', 'invalidkey', esc_html__( 'Your password reset link appears to be invalid. Please request a new link below.', WP_ULIKE_PRO_DOMAIN ) ),
        "expiredkey"     => WP_Ulike_Pro_Options::getFormLabel( 'rp', 'expiredkey', esc_html__( 'Your password reset link has expired. Please request a new link below.', WP_ULIKE_PRO_DOMAIN ) ),
...
function  wp_ulike_pro_social_share_shortcode( $atts ){
    ...
    echo sprintf( '<div class="ulp-social-share ulp-social-skin-%s ulp-social-buttons-color-%s ulp-social-shape-%s ulp-social-view-%s">', $skin, $color, $shape, $view );
