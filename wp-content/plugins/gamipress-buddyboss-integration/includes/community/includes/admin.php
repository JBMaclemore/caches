...
function gamipress_bp_settings_meta_boxes( $meta_boxes ) {
    ...
    $meta_boxes['gamipress-bp-settings'] = array(
        'title' => __( 'BuddyBoss', 'gamipress-buddyboss-integration' ),
        'fields' => apply_filters( 'gamipress_bp_settings_fields', array(

            // Points Types

            $prefix . 'points_placement' => array(
                'name' => __( 'Where Place User Points?', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Check the areas you wish to show the user points.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
                'classes' => 'gamipress-switch',
                'options' => array(
                    'top'       => __( 'At top of the user profile (before the user name)', 'gamipress-buddyboss-integration' ),
                    'listing'   => __( 'On members listing', 'gamipress-buddyboss-integration' ),
                    'activity'  => __( 'On activities', 'gamipress-buddyboss-integration' ),
                ),
            ),
            $prefix . 'members_points_types' => array(
                'name' => __( 'Points Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Choose the points types you want to show.', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_bp_members_points_types_option_cb',
            ),
            $prefix . 'members_points_types_top_thumbnail' => array(
                'name' => __( 'Show Thumbnail', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the points type featured image.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'members_points_types_top_thumbnail_size' => array(
                'name' => __( 'Thumbnail Size', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Set the thumbnail size (in pixels).', 'gamipress-buddyboss-integration' ),
                'type' => 'text',
                'default' => '25',
            ),
            $prefix . 'members_points_types_top_label' => array(
                'name' => __( 'Show Label', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the points type singular or plural label.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'achievements_placement' => array(
                'name' => __( 'Where Place User Achievements?', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Check the areas you wish to show the user achievements.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
                'classes' => 'gamipress-switch',
                'options' => array(
                    'top'       => __( 'At top of the user profile (before the user name)', 'gamipress-buddyboss-integration' ),
            ...
            $prefix . 'members_achievements_types' => array(
                'name' => __( 'User Profile Achievement Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Choose the achievement types you want to show.', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
            ...
            $prefix . 'members_achievements_top_thumbnail' => array(
                'name' => __( 'Show Thumbnail', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the achievement featured image.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'members_achievements_top_title' => array(
                'name' => __( 'Show Title', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the achievements title.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'members_achievements_top_link' => array(
                'name' => __( 'Show Link', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Add a link to the achievement page.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'members_achievements_top_label' => array(
                'name' => __( 'Show Label', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the achievement type label.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'members_achievements_top_limit' => array(
                'name' => __( 'Limit', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Number of achievements to display.', 'gamipress-buddyboss-integration' ),
                'type' => 'text',
                'default' => '10',
            ),
            ...
            $prefix . 'ranks_placement' => array(
                'name' => __( 'Where Place User Ranks?', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Check the areas you wish to show the user ranks.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
                'classes' => 'gamipress-switch',
                'options' => array(
                    'top'       => __( 'At top of the user profile (before the user name)', 'gamipress-buddyboss-integration' ),
            ...
            $prefix . 'members_ranks_types' => array(
                'name' => __( 'Rank Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Choose the rank types you want to show.', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
            ...
            $prefix . 'members_ranks_top_title' => array(
                'name' => __( 'Show Title', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the rank title.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'members_ranks_top_link' => array(
                'name' => __( 'Show Link', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Add a link to the rank page.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'members_ranks_top_label' => array(
                'name' => __( 'Show Label', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Show the rank type label.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'email_settings' => array(
                'name' => __( 'Add GamiPress Email Settings', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Display the GamiPress email settings to the user\'s email preferences.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'email_groups' => array(
                'name' => __( 'Divide Email Settings Per Groups', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Display email settings divided per groups.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'email_types' => array(
                'name' => __( 'Divide Email Settings Per Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Display email settings divided per types.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
        ...
        'tabs' => apply_filters( 'gamipress_bp_settings_tabs', array(
            'points' => array(
                'title' => __( 'Points', 'gamipress-buddyboss-integration' ),
            ...
            'achievements' => array(
                'title' => __( 'Achievements', 'gamipress-buddyboss-integration' ),
            ...
            'ranks' => array(
                'title' => __( 'Ranks', 'gamipress-buddyboss-integration' ),
                'icon' => 'dashicons-rank',
                'fields' => array(
            ...
            'emails' => array(
                'title' => __( 'Email Setttings', 'gamipress-buddyboss-integration' ),
    ...
    $meta_boxes['gamipress-bp-tab-settings'] = array(
        'title' => __( 'BuddyBoss Profile Tab', 'gamipress-buddyboss-integration' ),
        'fields' => apply_filters( 'gamipress_bp_tab_settings_fields', array_merge( array(

            // Points Types

            $prefix . 'points_tab' => array(
                'name' => __( 'Enable Profile Points Tab', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Check this option to show the user points on a profile tab.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'points_tab_title' => array(
                'name' => __( 'Tab Title', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Text to show on the BuddyBoss user profile.', 'gamipress-buddyboss-integration' ),
                'type' => 'text',
                'default' => __( 'Points', 'gamipress-buddyboss-integration' ),
            ),
            $prefix . 'points_tab_slug' => array(
                'name' => __( 'Tab Slug (Optional)', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'URL slug to use on the profile tab. Leave blank and slug will be a URL version of the tab title (eg: "My Tab Title" will have a slug like "my-tab-title").', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Important:</strong> If you set a tab title with special characters then provide a slug with URL friendly characters.', 'gamipress-buddyboss-integration' ),
                'type' => 'text',
            ),
            $prefix . 'tab_points_types' => array(
                'name' => __( 'Points Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Choose the points types you want to show on BuddyBoss user profile.', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
            ...
            $prefix . 'achievements_tab' => array(
                'name' => __( 'Enable Profile Achievements Tab', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Check this option to show the user achievements on a profile tab.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'achievements_tab_title' => array(
                ...
                'desc' => __( 'Text to show on the BuddyBoss user profile.', 'gamipress-buddyboss-integration' ),
                'type' => 'text',
                'default' => __( 'Achievements', 'gamipress-buddyboss-integration' ),
            ),
            ...
            $prefix . 'tab_achievements_types' => array(
                'name' => __( 'Achievement Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Choose the achievement types you want to show on BuddyBoss user profile achievements tab.', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_bp_tab_achievements_types_option_cb',
            ),
            $prefix . 'members_achievements_template_title' => array(
                'name'        => __( 'Achievements Tab Display Options', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Setup how achievements should look on the BuddyBoss user profile tab.', 'gamipress-buddyboss-integration' ),
                'type'        => 'title',
            ),
            $prefix . 'members_achievements_columns' => array(
                'name'        => __( 'Columns', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Columns to divide achievements.', 'gamipress-buddyboss-integration' ),
                'type'  => 'select',
                'options' => array(
                    '1' => __( '1 Column', 'gamipress-buddyboss-integration' ),
                    '2' => __( '2 Columns', 'gamipress-buddyboss-integration' ),
                    '3' => __( '3 Columns', 'gamipress-buddyboss-integration' ),
                    '4' => __( '4 Columns', 'gamipress-buddyboss-integration' ),
                    '5' => __( '5 Columns', 'gamipress-buddyboss-integration' ),
                    '6' => __( '6 Columns', 'gamipress-buddyboss-integration' ),
                ),
                'default' => '1'
            ),
            $prefix . 'members_achievements_limit' => array(
                'name'        => __( 'Limit', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Number of achievements to display.', 'gamipress-buddyboss-integration' ),
                'type'        => 'text',
                'default'     => 10,
            ),
            $prefix . 'members_achievements_orderby' => array(
                'name'        => __( 'Order By', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Parameter to use for sorting.', 'gamipress-buddyboss-integration' ),
                'type'        => 'select',
                'options'      => array(
                    'menu_order' => __( 'Menu Order', 'gamipress-buddyboss-integration' ),
                    'ID'         => __( 'Achievement ID', 'gamipress-buddyboss-integration' ),
                    'title'      => __( 'Achievement Title', 'gamipress-buddyboss-integration' ),
                    'date'       => __( 'Published Date', 'gamipress-buddyboss-integration' ),
                    'modified'   => __( 'Last Modified Date', 'gamipress-buddyboss-integration' ),
                    'author'     => __( 'Achievement Author', 'gamipress-buddyboss-integration' ),
                    'rand'       => __( 'Random', 'gamipress-buddyboss-integration' ),
                ),
                'default'     => 'menu_order',
            ),
            $prefix . 'members_achievements_order' => array(
                'name'        => __( 'Order', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Sort order.', 'gamipress-buddyboss-integration' ),
                'type'        => 'select',
                'options'      => array( 'ASC' => __( 'Ascending', 'gamipress-buddyboss-integration' ), 'DESC' => __( 'Descending', 'gamipress-buddyboss-integration' ) ),
                'default'     => 'ASC',
            ),
            ...
            $prefix . 'ranks_tab' => array(
                'name' => __( 'Enable Profile Ranks Tab', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Check this option to show the user ranks on a profile tab.', 'gamipress-buddyboss-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'ranks_tab_title' => array(
                ...
                'desc' => __( 'Text to show on the BuddyBoss user profile.', 'gamipress-buddyboss-integration' ),
                'type' => 'text',
                'default' => __( 'Ranks', 'gamipress-buddyboss-integration' ),
            ),
            ...
            $prefix . 'tab_ranks_types' => array(
                'name' => __( 'Rank Types', 'gamipress-buddyboss-integration' ),
                'desc' => __( 'Choose the rank types you want to show on BuddyBoss user profile ranks tab.', 'gamipress-buddyboss-integration' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress-buddyboss-integration' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_bp_tab_ranks_types_option_cb',
            ),
            $prefix . 'members_ranks_template_title' => array(
                'name'        => __( 'Ranks Tab Display Options', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Setup how ranks should look on the BuddyBoss user profile tab.', 'gamipress-buddyboss-integration' ),
                'type'        => 'title',
            ),
            $prefix . 'members_ranks_columns' => array(
                'name'        => __( 'Columns', 'gamipress-buddyboss-integration' ),
                'description' => __( 'Columns to divide ranks.', 'gamipress-buddyboss-integration' ),
                'type'  => 'select',
                'options' => array(
                    '1' => __( '1 Column', 'gamipress-buddyboss-integration' ),
                    '2' => __( '2 Columns', 'gamipress-buddyboss-integration' ),
            ...
            $prefix . 'members_ranks_orderby' => array(
                ...
                'type'        => 'select',
                'options'      => array(
                    'priority'   => __( 'Priority', 'gamipress-buddyboss-integration' ),
                    'ID'         => __( 'Rank ID', 'gamipress-buddyboss-integration' ),
                    'title'      => __( 'Rank Title', 'gamipress-buddyboss-integration' ),
                    'date'       => __( 'Published Date', 'gamipress-buddyboss-integration' ),
                    'modified'   => __( 'Last Modified Date', 'gamipress-buddyboss-integration' ),
                    'rand'       => __( 'Random', 'gamipress-buddyboss-integration' ),
                ),
...
function gamipress_bp_block_users_settings_meta_boxes( $meta_boxes ) {
    ...
    $meta_boxes['gamipress-bp-block-users-settings'] = array(
        'title' => __( 'BuddyBoss Block Users', 'gamipress-buddyboss-integration' ),
        'fields' => apply_filters( 'gamipress_bp_block_users_settings_fields', array(
            $prefix . 'blocked_member_types' => array(
                'name'          => __( 'Blocked Profile Types', 'gamipress-buddyboss-integration' ),
                'desc'          => __( 'Block users earnings by profile type. Users with those profile types will not be able to earn any GamiPress element.', 'gamipress-buddyboss-integration' )
                    . '<br>' . sprintf(
                        __( '<strong>Note:</strong> To block users by role or block specific users, check the <a href="%s" target="_blank">GamiPress - Block Users</a> add-on.', 'gamipress-buddyboss-integration' ),
