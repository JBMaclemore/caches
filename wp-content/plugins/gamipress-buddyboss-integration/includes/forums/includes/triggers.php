...
function gamipress_bbp_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'BuddyBoss Forums', 'gamipress-buddyboss-integration' )] = array(
        ...
        'gamipress_bbp_get_new_reply'               => __( 'Get a reply in a topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_get_specific_new_reply'      => __( 'Get a reply in a specific topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_get_specific_forum_reply'    => __( 'Get a reply in any topic of a specific forum', 'gamipress-buddyboss-integration' ),
        ...
        'gamipress_bbp_unfavorite_topic'          => __( 'Unfavorite a topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_unfavorite_topic' => __( 'Unfavorite a specific topic', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_specific_forum_unfavorite_topic' => __( 'Unfavorite any topic on a specific forum', 'gamipress-buddyboss-integration' ),
        'gamipress_bbp_get_unfavorite_topic'      => __( 'Lose a favorite on a topic', 'gamipress-buddyboss-integration' ),
...
function gamipress_bbp_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    $specific_activity_trigger_labels['gamipress_bbp_specific_new_reply'] = __( 'Reply to %s topic', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_specific_forum_reply'] = __( 'Reply to any topic on %s forum', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_get_specific_new_reply'] = __( 'Get a reply in %s', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_get_specific_forum_reply'] = __( 'Get a reply in any topic on %s forum', 'gamipress-buddyboss-integration' );
    ...
    $specific_activity_trigger_labels['gamipress_bbp_specific_unfavorite_topic'] = __( 'Unfavorite %s', 'gamipress-buddyboss-integration' );
    $specific_activity_trigger_labels['gamipress_bbp_specific_forum_unfavorite_topic'] = __( 'Unfavorite any topic on %s forum', 'gamipress-buddyboss-integration' );
