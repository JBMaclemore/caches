...
function gamipress_buddyboss_requirement_ui_fields( $requirement_id, $post_id ) {
    ...
    <span class="buddyboss-percentage"><?php echo __( 'percentage required', 'gamipress-buddyboss-integration' ); ?> <input type="number" class="input-buddyboss-percentage" value="<?php echo $buddyboss_percentage; ?>" placeholder="0" min="0" max="100" step="1">%</span>
