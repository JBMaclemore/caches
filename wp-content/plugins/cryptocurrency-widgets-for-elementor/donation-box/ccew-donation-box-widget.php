...

{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => __('Please Share Your Feedback', 'ccew'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            )
        );
        $this->add_control(
        ...
        <div class="ccew_cmc_def"><a href="https://wordpress.org/support/plugin/cryptocurrency-widgets-for-elementor/reviews/#new-post" target="_blank">Cryptocurrency Widgets For Elementor</a><br>
       You have been using this widget for a while. We hope you liked it ! Please give us a quick rating, it works as a boost for us to keep working on the plugin !</div>
        ...
        $this->add_control(
            'ccewd_important_note',
            array(
                'label' => __('Pro plugins', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::RAW_HTML,
                'show_label' => false,
                'raw' => '<ul class="ccew-permotion-plugins">
							<div class="ccew_cmc_demo">
							 <div class="ccew_logo_container"><a href="'.CCEW_DEMO_URL.'/#coins-marketcap" target="_blank"><img src="' . CCEW_URL . 'assets/images/coinmarketcap-logo.png" alt="Cryptocurrency widget for elementor" style="max-width:80px;"></a></div>
							...
							</div><div class="ccew_link_wrap"><a class="ccew_demo_link" href="'.CCEW_DEMO_URL.'/#coins-marketcap" target="_blank"><button class="ccew-custom-primry-btn">View Demos </button> </a> <a class="ccew_demo_buyk" href="https://codecanyon.net/item/coin-market-cap-prices-wordpress-cryptocurrency-plugin/21429844?s_rank=4" target="_blank"><button class="ccew-custom-primry-btn">Buy Pro</button></a></div>
							</div>
							<hr>
							<div class="ccew_cmc_demo">
							<div class="ccew_logo_container"><a href="'.CCEW_DEMO_URL.'/#cryptocurrency-widgets-pro" target="_blank"><img src="' . CCEW_URL . 'assets/images/crypto-widget-pro.png" alt="Cryptocurrency widget for elementor" style="max-width:80px;"></a></div>
							<div class="ccew_cmc_def"><strong>Cryptocurrency Widgets Pro</strong>
							Show cryptocurrency price table, historical charts, tickers and other widgets inside any page or post.</div><div class="ccew_link_wrap"><a class="ccew_demo_link" href="'.CCEW_DEMO_URL.'/#cryptocurrency-widgets-pro" target="_blank"><button class="ccew-custom-primry-btn">View Demos </button> </a><a class="ccew_demo_buyk"  href="https://codecanyon.net/item/cryptocurrency-price-ticker-widget-pro-wordpress-plugin/21269050?s_rank=5" target="_blank"><button class="ccew-custom-primry-btn">Buy Pro</button></a></div>
							</div>
						  </ul>',
