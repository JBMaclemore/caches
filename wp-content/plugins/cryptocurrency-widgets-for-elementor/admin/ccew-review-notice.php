...
if ( ! class_exists( 'ccew_review_notice' ) ) {
	class ccew_review_notice {
        ...
        <ul>
            ...
            <li class="already_rated"><a href="#" class="already_rated_btn button ccew_dismiss_notice" title="%7$s">%7$s</a></li>
            <li class="already_rated"><a href="#" class="already_rated_btn button ccew_dismiss_notice" title="%10$s">%10$s</a></li>
        </ul>
