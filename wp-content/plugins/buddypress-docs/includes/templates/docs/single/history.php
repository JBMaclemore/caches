...
<div class="<?php bp_docs_container_class(); ?>">
	...
	<?php if ( bp_docs_history_is_latest() ) : ?>
		...
		<p><?php _e( "Click on a revision date from the list below to view that revision. You can compare two revisions by selecting them in the 'Old' and 'New' columns, and clicking 'Compare Revisions'.", 'buddypress-docs' ) ?></p>
