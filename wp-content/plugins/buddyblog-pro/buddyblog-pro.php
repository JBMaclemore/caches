...
use BuddyBlog_Pro\Core\Data_Store;
use BuddyBlog_Pro\Core\Tab_State;
 ...
 * @property-read Data_Store $data In memory data store.
 * @property-read Tab_State  $tab_state Tab state.
