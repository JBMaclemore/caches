...
use BuddyBlog_Pro\Core\Fields\BBL_Field_Type_Iframe;
...
use BuddyBlog_Pro\Core\Fields\BBL_Field_Type_Gallery;
...
function bbl_get_registered_field_type_classes() {
	...
	$types = array(
		...
		'iframe'      => BBL_Field_Type_Iframe::class,
		...
		'gallery'     => BBL_Field_Type_Gallery::class,
