...
class Ajax_Draft_Handler {
	...
	public function save_draft() {
		...
		$pre_validate = apply_filters( 'bblpro_pre_validate_form_draft', true, $form, $_POST );
		...
		$post_data = (array) apply_filters( 'bblpro_post_draft_prepared_data', $post_data, $form_id, $_POST );
		// validate
	...
	public function revert_as_draft() {
		...
		$pre_validate = apply_filters( 'bblpro_pre_validate_revert_draft_action', true, get_post( absint( $_POST['bbl_form_id'] ) ), $_POST, $post );
