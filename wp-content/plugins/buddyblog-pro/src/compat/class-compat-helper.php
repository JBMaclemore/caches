...
class Compat_Helper {
	...
	private function setup() {
		...
		add_action( 'after_setup_theme', array( $this, 'load' ), - 100 );
	...
	/**
	 * Loads functions.php from the currently being used BuddyBlog template pack.
	 */
	public function load() {
		// locate functions.php in the template pack being used.(e.g. default/functions.php or 'buddyboss/functions.php' or 'kleo/functions.php' etc).
		$located_file = bblpro_locate_template_file( 'functions.php' );

		if ( $located_file && is_readable( $located_file ) ) {
			require $located_file;
		}
	}
